            ...
            {Number(data.numTokensMinted) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                <s.TextTitle
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  Mint 1 {CONFIG.SYMBOL} for {CONFIG.DISPLAY_COST}{" "}
                ...
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  Gas limit is set at 125,000 to ensure the mint does not fail.
                </s.TextDescription>

                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  You can save gas by minting up to 10 NFTs at one transaction. 
                </s.TextDescription>
                <s.TextDescription
                  style={{ textAlign: "center", color: "var(--accent-text)" }}
                >
                  Or minting when the network is not congested. 
                </s.TextDescription>
                <s.SpacerSmall />
                {blockchain.account === "" ||
